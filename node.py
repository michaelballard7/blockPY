    ...
    def listen_for_input(self):
        ...
        while waiting_for_input:
            ...
            if user_choice == '1':
                ...
                if self.blockchain.add_transaction(recipient, self.id, amount=amount): # add transactiont to open transactions
            ...
            print(" ------------------------------------------------ ")
            print(" ")
            print('Current Balance of {}\'s Account:{:6.2f}'.format(self.id, self.blockchain.get_balance()))
            print(" ")
        else:
            print('User left!')
